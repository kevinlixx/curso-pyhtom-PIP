...
def run():
  ...
  df = df[df['Continent'] == 'Africa'] #esta linea de codigo lo que hace es filtrar la lista de diccionarios con el contin
  countries = df['Country/Territory'].tolist() #esta linea de codigo lo que hace es crear una lista con los paises de la lista de diccion
  porcentages = df['World Population Percentage'].values#esta linea de codigo lo que hace es crear una lista con los porcentajes de la lista de diccion 
